...
(2) Tap *Ungroup* image:icons/ungroup.png[Ungroup] of the bottom *Edit Toolbar* image:icons/edit-toolbar-icons.png[Edit Toolbar].
...
(2) Tap the *Delete* image:icons/remove.png[Delete] button to delete. It is deleted.

image::screenshots/deleting-link-step-3.png[Linking Step 2]

[NOTE]
The *Delete* image:icons/remove.png[Delete] button is located on the bottom *Edit Toolbar* image:icons/edit-toolbar-icons.png[Edit Toolbar].
...
(2) Tap image:icons/gp_settings.png[Settings] Settings and tap image:icons/gp_premium.png[Premium] *Get Premium Subscription* item.

image::screenshots/get-premium-subscription.png[Get Premium Subscription]

(3) Show Premium Subscription dialog and get it.
