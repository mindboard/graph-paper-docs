...
[NOTE]
You can also convert from a temporary group to a presistent one with *group button* image:icons/group.png[Group] on the bottom Edit Toolbar.
...
[NOTE] 
The *Ungroup* image:icons/ungroup.png[Ungroup] is located on the bottom Edit Toolbar. +
